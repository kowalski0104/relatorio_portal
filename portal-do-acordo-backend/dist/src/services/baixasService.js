...
async function queryBaixas(prisma, empresaId, filter) {
...
export async function getBaixas(filter) {
    const results = await Promise.all(getLiveClients(filter.sistema).map(({ empresaId, prisma }) => queryBaixas(prisma, empresaId, filter)));
...
//# sourceMappingURL=baixasService.js.map