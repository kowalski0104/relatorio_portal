...
async function queryAcordos(prisma, empresaId, filter) {
...
export async function getAcordos(filter) {
    const results = await Promise.all(getLiveClients(filter.sistema).map(({ empresaId, prisma }) => queryAcordos(prisma, empresaId, filter)));
...
//# sourceMappingURL=acordosService.js.map